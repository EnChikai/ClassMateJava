...
<form action="/admin/updateFreeBoard" method="post" enctype="multipart/form-data">
...
<a href="../admin/freeBoardView?userNo=${freeBoard.userNo }"><button id="cancelBtn" type="button">뒤로</button></a>
