...
<div class="classMenu">
    ...
    <label style="font-size: 18px; padding: 11px 40px 11px 40px; color: black; background-color: #0000003d;" class="btn btn-secondary" for="btnradio1" id="onClass">ON 클래스</label>
    ...
    <label style="font-size: 18px; padding: 11px 40px 11px 40px; background-color: #F0C610; color: black; border: none;" class="btn btn-outline-warning" for="btnradio2" id="offClass">OFF 클래스</label>
    </div>
...
<form id="sortForm" action="/main/offClassList" method="get">
    <div class="dropdown" style="float: right;">
        <select name="sort" id="sortOrderSelect" onchange="submitForm()" style="border-radius: 4px; padding: 7px; padding-right: 52px;">
            <option value="class_no desc" ${classDescNo eq 2 ? 'selected' : ''}>등록일순</option>
