...
public class MainClassListPaging {
	...
	public MainClassListPaging(int totalCount, int curpage){
	...
	public MainClassListPaging(int totalCount, int curpage, int listCount, int pageCount){
		setTotalCount(totalCount);
		setCurPage(curpage);
